...
def main() -> None:
    ...
    parser.add_argument(
        "--pool-manifest",
        type=Path,
        default=Path("manifests/formal_train_pool.csv"),
    )
    ...
    outputs = {
        "formal_train": args.output_dir / "formal_train.csv",
        "internal_validation": args.output_dir / "internal_validation.csv",
        "development_train": args.output_dir / "development_train.csv",
        "development_validation": args.output_dir / "development_validation.csv",
    }
